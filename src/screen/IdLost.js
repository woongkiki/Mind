...
const IdLost = props => {
  ...
  const idSearch = () => {
    Api.send(
      'member_idSearch',
      {name: name, branch: branch, pNumber: phoneNumber},
      args => {
        let resultItem = args.resultItem;
        let arrItems = args.arrItems;
  ...
  return (
    <Box flex={1} backgroundColor="#fff">
        ...
        <Box p="20px">
          ...
          <Box mt="30px">
            ...
            <Select
              ...
              {/* <Select.Item label={"일반회원"} value={"일반회원"} key={branchListData.length + 1} /> */}
            </Select>
          </Box>
          <Box mt="30px">
      ...
      <SubmitButtons btnText="아이디 찾기" onPress={idSearch} />
