...
const SalesForm = (props) => {
    ...
    const salesWriteHandler = () => {
        ...
        Api.send('com_salesWrite', {'category':category, 'title':title, 'content':content, 'mb_id':userInfo.mb_id, 'wr_name':userInfo.mb_name, 'files':filess}, (args)=>{
            let resultItem = args.resultItem;
            let arrItems = args.arrItems;
    
            if(resultItem.result === 'Y' && arrItems) {
                console.log('sales hot-line 작성하기: ', resultItem);
                //setCategoryList(arrItems);
                ...
                console.log('sales hot-line 작성하기 실패!', resultItem);
                ToastMessage(resultItem.message)
            }
        });
    }
    ...
    return (
        <Box flex={1} backgroundColor='#fff'>
            <HeaderDef headerTitle='Sales Hot-line 작성하기' navigation={navigation} />
            {
                loading ? 
