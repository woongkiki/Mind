...
const BrandForm = (props) => {
    ...
    const categoryHandler = async () => {
        ...
        await Api.send('com_brandCategory', {}, (args)=>{
            ...
            if(resultItem.result === 'Y' && arrItems) {
                console.log('커뮤니케이션 지사/지점게시판 카테고리: ', arrItems, resultItem);
    ...
    const brandWriteHandler = () => {
        ...
        Api.send('com_brandWrite', {'category':category, 'title':title, 'content':content, 'mb_id':userInfo.mb_id, 'wr_name':userInfo.mb_name, 'brandId': userInfo.mb_1, 'files':filess}, (args)=>{
            let resultItem = args.resultItem;
            let arrItems = args.arrItems;
    ...
    return (
        <Box flex={1} backgroundColor='#fff'>
            <HeaderDef headerTitle='지사 / 지점게시판' navigation={navigation} />
            {
                loading ? 
