...
const MemoForm = props => {
  ...
  return (
    <Box flex={1} backgroundColor="#fff">
            ...
            <HStack justifyContent={'space-between'}>
              <Box
                ...
                {memberName != '' ? (
                  <DefText
                    text={memberName}
                    style={{fontSize: fsize.fs12, color: '#333'}}
                  />
                ) : (
                  <DefText
                    text={'받는사람을 입력해 주세요.'}
            ...
            <TouchableOpacity
              ...
              <HStack alignItems={'center'} justifyContent="space-between">
                {fileNames != '' ? (
                  <DefText
                    text={fileNames}
                    style={[styles.buttonsText, {color: '#333'}]}
                  />
                ) : (
                  <DefText
                    text="첨부하실 파일을 업로드하세요."
                    style={[styles.buttonsText, {color: '#999'}]}
                  />
                )}
      ...
      <SubmitButtons btnText="작성하기" onPress={() => memoSend()} />
        ...
        <Modal.Content
          ...
          <Modal.Body>
            ...
            <HStack mt="15px">
              <DefText
                text="같은 지사(지점) 내"
                style={{color: colorSelect.orange}}
              />
                  ...
                  return (
                    <Box
                      ...
                      <Box position={'absolute'} top="15px" right="15px">
                        <TouchableOpacity
                          onPress={() => memberSelect(item.mb_name, item.mb_no)}
                          style={{
