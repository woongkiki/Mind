...
const ScheduleAdd = props => {
  ...
  useEffect(() => {
    console.log(selectClient, selectClientIdx);
  }, [selectClient, selectClientIdx]);
  ...
  const addr2Change = text => {
    setAddr2(text);
  };

  //고객명
  const [clientName, setClientName] = useState('');
  const selectClientChange = text => {
  ...
  useEffect(() => {
    if (isFocused) {
      if (params != '') {
        ...
        if (params.mb_name != '') {
          setSelectClient(params.mb_name);
        }

        if (params.mb_idx != '') {
          setSelectClientIdx(params.mb_idx);
        }
      }
    }
  }, [isFocused]);
    ...
    <Box flex={1} backgroundColor="#fff">
      ...
      <ScrollView>
        <Box p="20px">
          ...
          {categorys == '교육' ? (
            <Box mt="30px">
              <DefText text={'기간'} style={[styles.labelTitle]} />
                    ...
                    <HStack
                      ...
                      {endDate != '' ? (
                        ...
                        <DefText
                          text="시간을 선택해 주세요."
                          style={[
                            {fontSize: fsize.fs12, color: colorSelect.black666},
                          ]}
                        />
                      )}
                      <Image
              ...
              <HStack justifyContent={'space-between'}>
                <Box
                  ...
                  <DefInput
                    ...
                    onChangeText={selectClientChange}
                  />
                  {/* {
                                        selectClient != '' ?
                ...
                <HStack alignItems={'center'}>
                  <Box
                    style={[
                      ...
                      alarm == '기본(2시간 전)' && {backgroundColor: '#004375'},
                    ]}>
                    {alarm == '기본(2시간 전)' && (
                      <Image
      ...
      <SubmitButtons btnText="완료" onPress={scheduleAdd} />
      <DateTimePickerModal
