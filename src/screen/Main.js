    ...
    const MoveMenu = () => {
     ...
     return(
         ...
         <View style={[styles.TabBarMainContainer]} >
             ...
             <TouchableOpacity
                activeOpacity={0.8} 
                style={[styles.button, {borderLeftWidth:1, borderLeftColor:'#E3E2E3', borderTopLeftRadius:20}]}
                onPress={MoveDb}
            >
                {
                    screenName == 'Db' ?
                    <>
                        <Image source={require('../images/tabIconDbOn.png')} alt='DB' style={{width:21, height:21, resizeMode:'contain'}}/>
                        <DefText text='DB' style={[styles.tabText, {color:'#F99600'}]} /> 
                    </>
                    :
                    <>
                        <Image source={require('../images/tabIconDb.png')} alt='DB' style={{width:21, height:21, resizeMode:'contain'}}/>
                        <DefText text='DB' style={[styles.tabText]} /> 
                    </>
                }
             </TouchableOpacity>
             <TouchableOpacity 
            ...
            >
                {
                    screenName == 'Schedule' ?
                    <>
                        <Image source={require('../images/tabIconScheduleOn.png')} alt='스케줄' style={{width:21, height:21, resizeMode:'contain'}}/>
                        <DefText text='스케줄' style={[styles.tabText, {color:'#F99600'}]} /> 
                    </>
                    :
                    <>
                        <Image source={require('../images/tabIconSchedule.png')} alt='스케줄' style={{width:21, height:21, resizeMode:'contain'}}/>
            ...
            >
                {
                    screenName == 'Home' ?
                    <>
                        <Image source={require('../images/tabIconHomeOn.png')} alt='홈' style={{width:21, height:21, resizeMode:'contain'}}/>
                        <DefText text='홈' style={[styles.tabText, {color:'#F99600'}]} /> 
                    </>
                    :
                    <>
                        <Image source={require('../images/tabIconHome.png')} alt='홈' style={{width:21, height:21, resizeMode:'contain'}}/>
            ...
            >
                {
                    ...
                    <>
                        <Image source={require('../images/tabIconComOn.png')} alt='커뮤니케이션' style={{width:21, height:21, resizeMode:'contain'}}/>
                        <DefText text='커뮤니케이션' style={[styles.tabText, {color:'#F99600'}]}  /> 
                    </>
                    :
                    <>
                        <Image source={require('../images/tabIconCom.png')} alt='커뮤니케이션' style={{width:21, height:21, resizeMode:'contain'}}/>
                        <DefText text='커뮤니케이션' style={[styles.tabText]} /> 
                    </>
                }
             ...
             <TouchableOpacity
                onPress={MoveMenu}
                activeOpacity={0.8}
                style={[styles.button, {borderRightWidth:1, borderRightColor:'#E3E2E3', borderTopRightRadius:20}]}
            >
                {
                    screenName == 'Menu' ?
                    <>
                        <Image source={require('../images/tabIconMenuOn.png')} alt='전체 메뉴' style={{width:21, height:21, resizeMode:'contain'}}/>
                        <DefText text='전체 메뉴' style={[styles.tabText, {color:'#F99600'}]}  /> 
                    </>
                    :
                    <>
                        <Image source={require('../images/tabIconMenu.png')} alt='전체 메뉴' style={{width:21, height:21, resizeMode:'contain'}}/>
